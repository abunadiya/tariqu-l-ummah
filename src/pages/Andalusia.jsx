  ...
  return (
    ...
    >
      <div className="accordion encyclopedia-accordion shadow-sm" id="andalusiaAccordion">
        ...
        >
          <p>
            После падения Дамаска в 132 г.х. чудом выживший 20-летний омейядский принц Абд
            ар-Рахман I (ад-Дахиль — «Пришелец»), спасаясь от преследований, пересекает
        ...
        >
          <p>
            ...
            лже-халифат Фатимидов, суннитское население Андалусии оказалось под угрозой
            духовного уничтожения. Чтобы защитить Умму на Западе, великий эмир Абд ар-Рахман
            ...
            спасения верующих от ереси. Это эпоха величайшего расцвета фикха, суннитских
            наук и архитектуры.
          </p>
          <SourceVerification
            waqfeyaId="1285"
        ...
        >
          <p>
            ...
            ставку на наёмные войска, единый Халифат рушится в 422 г.х. Страна распадается
            ...
            братьев-мусульман привели к падению региона. В 897 г.х. (1492 г. н.э.) последний
            эмир Гранады Абу Абдаллах сдаёт город без боя, потеряв Андалусию навсегда.
          </p>
          <SourceVerification
            waqfeyaId="3401"
            buttonClass="btn-source-emerald"
